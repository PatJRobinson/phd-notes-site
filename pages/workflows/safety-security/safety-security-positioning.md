...
- Safety and security are distinct but can become entangled in cyber-physical robotics.
...
- Security always causes safety failure.
- Safety and security are the same.
