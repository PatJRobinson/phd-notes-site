# Rotifer Paper Writing Route

## 10-minute route

1. [paper-claim.md](paper-claim.md)
2. [safety-security-thread.md](safety-security-thread.md)
3. [open-tensions.md](open-tensions.md)

## 30-minute route

1. [positioning.md](positioning.md)
2. [contribution-map.md](contribution-map.md)
3. [evidence-map.md](evidence-map.md)
4. [source-provenance.md](source-provenance.md)
