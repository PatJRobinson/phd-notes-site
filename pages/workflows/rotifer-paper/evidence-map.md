...
- Provider/deployment devlogs showing the technical vocabulary stabilising.
- Project ideology and positioning notes explaining the intellectual role.

## Weak or suggestive evidence

- Forest-for-the-trees note: useful positioning, but conversation-derived.
- ROSness note: relevant to deployment context but needs source audit.

## Missing evidence

- External evaluation of Rotifer by users.
- Robust comparison across more than one worked case.
- Strong link from assumption tracing to formal assurance artefacts.
