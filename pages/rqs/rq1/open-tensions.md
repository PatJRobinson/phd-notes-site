...
- Earlier secure-by-design framing emphasised developer attitudes and mental models more strongly than the current RQ wording.
- Threat-model coupling remains useful but may overdetermine interviews if introduced too early.

## Superseded tensions

- "Do developers understand security?" is too flat. The current question asks how system understanding is constructed and maintained.
...
- RQ1 may become generic HCI rather than robotics integration research.
- The empirical study may collect broad attitudes without enough system-specific detail.
