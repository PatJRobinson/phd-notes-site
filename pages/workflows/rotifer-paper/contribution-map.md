# Rotifer Paper Contribution Map
...
- `supports` RQ2 by separating system boundaries and realisation layers.
- `supports` RQ3 through command authority and safety/security relevance.
- `supports` RQ4 through claim/evidence scoping.
- `is_example_of` RQ1 artefact-mediated understanding.

## Boundary

The contribution is explanatory and methodological, not an enforcement mechanism.
