...
Hold the current project-wide thesis model across RQ1-RQ4.

## Current status

Active. The current centre is ROS 2-style integration as the place where behaviour, boundaries, safety/security concerns, and assurance conditions are constructed and maintained.
...
[Modularity shifts work to integration](../../arguments/modularity-shifts-work-to-integration.md), [System boundaries are operationally constructed](../../arguments/system-boundaries-are-operationally-constructed.md), [Safety/security emerges at integration interfaces](../../arguments/safety-security-emerges-at-integration-interfaces.md).
